...
* TODO Odvod
Odvod funkcije $f(x)$ je definiran kot limita diferenčnega kvocienta. Vrednost
odvoda $f'(x)$ v neki točki $x$, veliko pove o tem, kako se funkcija obnaša lokalno v
okolici točke $x$. Zato je eno osnovnih orodij analize.
