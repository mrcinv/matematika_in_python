...
Razred lahko razširimo z osnovnimi operacijami, tako da z ukazom ~setattr~
prepišemo 
...
*** TODO Testi                                                     :noexport:
Check.part()
self.assertEqual('kolinearna([1,2,3], [2,4,6])', True)
self.assertEqual('kolinearna([0,0,0,0], [1,2,3,4])', True)
self.assertEqual('kolinearna([1,0], [1,0,0])', False)
...
*** TODO Testi                                                     :noexport:
Check.part()
self.assertEqual('koplanarni([1,2,0], [2,4,0],[-2,3,0])', True)
self.assertEqual('koplanarni([1,0,0], [0,1,0],[0,0,1])', False)
self.assertEqual('koplanarni([1,2,2], [0,1,2],[0,0,1])', False)
self.assertEqual('koplanarni([1,0,-3], [0,1,0],[1,1,-3])', True)
self.assertEqual('koplanarni([1,2,3], [0,1,2],[0,0,0])', True)
self.assertEqual('koplanarni([0,1,0], [0,1,2],[1,0,1])', False)
