...
ampak jo raje prepišite ali še bolje napišite sami. Tako bosMatematika skozi Pythonte imeli
več od tega.
...
#+BEGIN_SRC python :tangle test_vektorji
...
self.assertEqual('Premica([1,2,0],[1,0,0])==Premica.skozi_tocke([1,0,0],[2,2,0])', True)
self.assertEqual('Premica.skozi_tocke([1,1,1],[3,5,1])==Premica([2,4,0],[2,1,0])', False)
...
self.assertEqual('presecisce(Premica.skozi_tocke([1,1,1],[0,2,2]),Ravnina([-1,0,1],[0,2,1]))',[0.5,1.5,1.5])
for i in range(10):
